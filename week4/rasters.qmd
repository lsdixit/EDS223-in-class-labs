...
```{r}
# create a map/plot to view the data
...
# row-column indexing for cell id 468
zion_elevation[2,3]
```
...
# assign elevation of <20 m to NA
...
# set all cells <2000m to NA
rmask[rmask < 2000] <- NA
# we don't need to specify layers since this one only has one

# subset elevation raster based on our mask
# approach 1: bracket subsetting
mask1 <- zion_elevation[rmask, drop = FALSE]
...
# change reclassified values into factors to look at summary
