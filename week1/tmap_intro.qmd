...
tm_shape(world_vector)+
  ...
  # fill.scale = tm_scale_breaks = c(0, 5000, 10000, 20000, 40000, 80000)
  # fill.scale = tm_scale(breaks = c(0, 5000, 10000, 50000, Inf),
...
```{r}
tmap_mode("view")
# any map that we now make is interactive
```
